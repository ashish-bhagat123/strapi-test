...
/**
 * hindi-insight controller
 */

const {createCoreController} = require('@strapi/strapi').factories;

module.exports = createCoreController('api::hindi-insight.hindi-insight', ({strapi}) => ({
  async find(ctx) {
  ...
  async findOne(ctx) {
    ...
    const entity = await strapi.db.query('api::hindi-insight.hindi-insight').findOne({
      where: {slug: id},
    });
